    ...
    generateEventRows = () => {
        return this.props.events.map(event => {
            ...
            switch (event.syncStatus) {
                case "Synced":
                    rowClassName = "synced";
                    tooltip = <div className="tooltip-container">Synced date: {moment(event.syncedDate).format("YYYY-MM-DD")}</div>
                    break;
                case "Pendding":
                ...
                case "Rejected":
                    ...
                    tooltip = <div className="tooltip-container">Rejected reason: {event.syncErrorMessage}</div>
                    break;
                default: break;
            }

            return <Tooltip id="tooltip-bottom" title={tooltip} placement="left">
